    ...
    <div className="mx-5">
      ...
      <form onSubmit={blogPostHandler} className="flex flex-col text-zinc-100">
        <div className="my-1">
          title:
          <input
            className="mx-8 bg-zinc-900 border-2 border-zinc-600 p-1"
            type="text"
            name="title"
            placeholder="title"
            id="title"
        ...
        <div className="my-1">
          author:
          <input
            className="mx-3 bg-zinc-900 border-2 border-zinc-600 p-1"
            type="text"
            name="author"
            placeholder="author"
            id="author"
        ...
        <div className="my-1">
          url:
          <input
            className="mx-10 bg-zinc-900 border-2 border-zinc-600 p-1"
            type="text"
            name="url"
            placeholder="url"
            id="url"
        ...
        <button
          id="postBlog-btn"
          type="submit"
          className="w-64 border-2 text-xl text-zinc-100 font-extrabold hover:text-green-500 border-2 rounded-md
