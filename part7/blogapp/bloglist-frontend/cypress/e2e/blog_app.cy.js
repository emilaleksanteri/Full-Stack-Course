describe('Blog app', function () {
  ...
  describe('when logged in', function () {
    ...
    it('user !== blog owner, unable to remove blog', function () {
      ...
      cy.contains('Cypress Testing | Test').contains('view').click()
  ...
  describe('blog like ranking', function () {
    beforeEach(function () {
      cy.login({ username: 'emilTest', password: '2tr@ongPasswrd' })
      cy.postBlog({
        title: 'Cypress Testing 1',
        author: 'Test',
        url: 'noUrl',
        likes: '1',
      })
      cy.postBlog({
        title: 'Cypress Testing 2',
        author: 'Test',
        url: 'noUrl',
        likes: '2',
      })
      cy.postBlog({
        title: 'Cypress Testing 3',
        author: 'Test',
        url: 'noUrl',
        likes: '3',
      })
    ...
    it.only('blogs displayed from most liked to least liked', function () {
      ...
      cy.contains('Cypress Testing 1 | Test').contains('view').click()
      cy.contains('Cypress Testing 2 | Test').contains('view').click()
      cy.contains('Cypress Testing 3 | Test').contains('view').click()
      ...
      cy.get('.individualBlog').eq(1).contains('like').click()
